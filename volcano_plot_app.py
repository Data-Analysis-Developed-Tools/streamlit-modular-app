...
# Codice corretto per volcano_plot_app.py dopo il reset dell'ambiente
codice_corretto = '''import streamlit as st
import pandas as pd
...
file_path = Path("/mnt/data/volcano_plot_app.py")
file_path.write_text(codice_corretto)
