...
def mostra_volcano_plot():
    ...
    try:
        fig = px.scatter(
            ...
            x='Log2FoldChange',
            y='-log10(p-value)', 
            text='EtichettaVariabile' if show_labels else None,  # ✅ CORRETTO
            hover_data=['EtichettaVariabile'],                    # ✅ CORRETTO
    ...
    if fold_change_threshold != default_fold_change or p_value_threshold != default_p_value:
        ...
        ][['EtichettaVariabile', '-log10(p-value)', 'Log2FoldChange']]  # ✅ CORRETTO
